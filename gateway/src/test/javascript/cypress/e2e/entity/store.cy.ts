...
describe('Store e2e test', () => {
  ...
  const storeSample = { name: 'Mountains wireless Market', address: 'overriding', createTimestamp: '2022-10-18T17:34:05.664Z' };
  ...
  describe('new Store page', () => {
    ...
    it('should create an instance of Store', () => {
      ...
      cy.get(`[data-cy="createTimestamp"]`).type('2022-10-19T02:52').blur().should('have.value', '2022-10-19T02:52');

      cy.get(`[data-cy="updateTimestamp"]`).type('2022-10-18T13:40').blur().should('have.value', '2022-10-18T13:40');
